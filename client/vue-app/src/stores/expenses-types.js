...
import { getAll, create, remove, update } from '@/http/expenses-types'

export const useExpensesTypesStore = defineStore("expensesTypesStore", () => {
    ...
    const fetchItems = async () => {
        ...
        collection.value = data.expenses_types
        loading.value = false
    }
